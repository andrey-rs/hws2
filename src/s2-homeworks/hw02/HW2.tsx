...
//AffairType[]
// constants
const defaultAffairs: Array<AffairType> = [ // need to fix any - Array???
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) :void => { // need to fix any
        // const resultFilter = deleteAffair(affairs,_id);
        // setAffairs(resultFilter)
